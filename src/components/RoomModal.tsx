...
import { X, Check, Users, Maximize, Bed, MessageCircle, ShieldCheck, Sparkles } from "lucide-react";
      ...
      >
        ...
        <div className="relative h-64 sm:h-80 w-full overflow-hidden rounded-t-3xl">
          ...
          <div className="absolute bottom-6 left-6 right-6 flex flex-wrap items-end justify-between gap-4">
            <div>
              <span className="inline-block px-3 py-1 rounded-full bg-gold-500/20 border border-gold-500/40 text-gold-400 text-xs tracking-wider uppercase font-semibold mb-2">
                {room.category}
              </span>
              <h2 className="font-heading text-2xl sm:text-4xl font-bold text-neutral-light">
                {room.name}
              </h2>
            </div>
            <div className="text-right">
              <span className="text-xs text-neutral-gray block">Tarifa por noche</span>
              <span className="text-2xl sm:text-3xl font-bold text-gold-gradient font-heading">
                {room.pricePerNight} <span className="text-xs text-neutral-light font-sans font-normal">COP</span>
              </span>
            </div>
          </div>
        </div>
        ...
        <div className="p-6 sm:p-8 space-y-8">
          ...
          {/* Key Highlights */}
          <div className="p-5 rounded-2xl bg-gold-500/10 border border-gold-500/20">
          ...
          <div className="flex flex-col sm:flex-row gap-4 pt-4 border-t border-white/10">
            <a
              ...
              className="flex-1 inline-flex items-center justify-center gap-2.5 bg-[#25D366] hover:bg-[#20ba5a] text-white font-bold py-3.5 px-6 rounded-xl shadow-lg shadow-emerald-900/30 transition-all hover:scale-[1.02] active:scale-[0.98]"
            >
            ...
            <button
              onClick={onClose}
              className="px-6 py-3.5 rounded-xl border border-white/15 text-neutral-gray hover:text-neutral-light hover:bg-white/5 transition-colors font-medium text-sm"
            >
              Cerrar
            </button>
          </div>
